...
const Box = styled(motion.div)<{ bgPhoto: string; rank: boolean }>`
...
const Slider = ({ data, offset, title, rank, category, type }: ISProps) => {
      ...
      >
        ...
        >
          <ButtonWrapper>
            ...
            >
              <MdChevronRight size="3vw" />
            </Button>
          </ButtonWrapper>
          {data?.results
            .slice(offset * index, offset * index + offset)
            .map((movie, i) => (
              <BoxWrapper className="box" key={movie.id ?? i}>
                {rank && (
                  <svg
                    viewBox={
                      i === 0
                ...
                <>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <span style={{ fontWeight: "bold" }}>POSTER</span>
                        <img
                      ...
                      >
                        ...
                        >
                          <span style={{ fontWeight: "bold" }}>개봉 날짜</span>
                        ...
                        >
                          <span style={{ fontWeight: "bold" }}>관람 등급</span>
                          {clickedMovie.adult ? "19세 관람가" : "전체 관람가"}
                        </div>
                      </div>
                    </div>
                  </div>
